...
<main class="signup-form">
    <form class="signup-form" method="post">
        ...
        <fieldset class="section-box">
            ...
            <label>How did you hear about NAMI Rappahannoc?</label>
            ...
            <label>What are your hobbies? Are there any specific skills/interests you have that you believe could be useful for volunteering at NAMI Rappahannoc?</label>
