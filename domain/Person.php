...
class Person {
    ...
    function get_street_address()                 { return $this->street_address; }
    function get_city()                           { return $this->city; }
    function get_state()                          { return $this->state; }
    function get_notes()                          { return $this->notes; }
    function get_zip_code()                       { return $this->zip_code; }
    function get_phone1()                         { return $this->phone1; }
    function get_phone1type()                     { return $this->phone1type; }
    function get_email()                          { return $this->email; }
    function get_emergency_contact_first_name()   { return $this->emergency_contact_first_name; }
    function get_emergency_contact_last_name()    { return $this->emergency_contact_last_name; }
    function get_emergency_contact_phone()        { return $this->emergency_contact_phone; }
    function get_emergency_contact_phone_type()   { return $this->emergency_contact_phone_type; }
    function get_emergency_contact_relation()     { return $this->emergency_contact_relation; }
    function get_tshirt_size()                    { return $this->tshirt_size; }
    function get_school_affiliation()             { return $this->school_affiliation; }
    function get_photo_release()                  { return $this->photo_release; }
    function get_photo_release_notes()            { return $this->photo_release_notes; }
    function get_type()                           { return $this->type; }
    function get_status()                         { return $this->status; }
    function get_archived()                       { return $this->archived; }
    function get_access_level()                   { return $this->access_level; }
    function get_how_you_heard_of_stepva()        { return $this->how_you_heard_of_stepva; }
    function get_preferred_feedback_method()      { return $this->preferred_feedback_method; }
    function get_hobbies()                        { return $this->hobbies; }
    function get_professional_experience()        { return $this->professional_experience; }
    function get_disability_accomodation_needs()  { return $this->disability_accomodation_needs; }
    function get_training_complete()              { return $this->training_complete; }
    function get_training_date()                  { return $this->training_date; }
    function get_orientation_complete()           { return $this->orientation_complete; }
    function get_orientation_date()               { return $this->orientation_date; }
    function get_background_complete()            { return $this->background_complete; }
    function get_background_date()                { return $this->background_date; }
    function get_strengths()                      { return $this->strengths; }
    function get_primary_role()                   { return $this->primary_role; }
    function get_work_best()                      { return $this->work_best; }
    function get_learning_method()                { return $this->learning_method; }
    function get_introOrExtro()                   { return $this->introOrExtro; }
    function get_family_with_mental_illness()     { return $this->family_with_mental_illness; }
    function get_involvement_in_nami()            { return $this->involvement_in_nami; }
    function get_interest()                       { return $this->interest; }
    function get_active_paying_nami_affiliate()   { return $this->active_paying_nami_affiliate; }
    function get_if_not_are_willing()             { return $this->if_not_are_willing; }
    function get_choice_nami_affiliate()          { return $this->choice_nami_affiliate; }
    function get_may_text()                       { return $this->may_text; }
}
