<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && !isset($_GET['id'])) {
        ...
        if (!valueConstrainedTo($new_role, ['volunteer', 'participant', 'admin', 'board', 'donator'])) {
            die();
        }
        if (empty($new_role)){
...
<html>
    <head>
        ...
        <title>NAMI Rappahannock | Archive User</title>
        <style>
            .modUser{
                display: flex;
    ...
    <body>
        ...
        <main class="user-role">
            ...
            if ($accessLevel == 3) {
				$roles = array('volunteer' => 'Volunteer', 'admin' => 'Admin','board' => 'Board Member');
