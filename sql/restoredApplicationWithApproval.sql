...
--
-- Dumping data for table `dbcsgapplication`
--

INSERT INTO `dbcsgapplication` (`csgApplicationID`, `reasonToBecomeCSG`, `whyIsNowRightTime`, `statusInRecoveryJourney`, `screenerName`, `screeningDate`, `approved`, `id`) VALUES
(1, 'w', 'w', 'w', 'name1', '0222-02-02', 0, 'vmsroot');
...
CREATE TABLE `dbf2fapplication` (
  ...
  `screenerName` text NOT NULL,
  `screeningDate` date NOT NULL,
  `approved` varchar(4) NOT NULL DEFAULT '0',
  `id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `dbf2fapplication`
--

INSERT INTO `dbf2fapplication` (`f2fApplicationID`, `reasonToBecomeF2F`, `whyIsNowRightTime`, `screenerName`, `screeningDate`, `approved`, `id`) VALUES
(1, '2', '2', 'name1', '2222-02-22', '0', 'vmsroot');
...
--
-- Dumping data for table `dbfsgapplication`
--

INSERT INTO `dbfsgapplication` (`fsgApplicationID`, `reasonToBecomeFSG`, `whyIsNowRightTime`, `screenerName`, `screeningDate`, `approved`, `id`) VALUES
(1, '2', '2', 'name2', '0002-02-20', '0', 'vmsroot');
...
--
-- Dumping data for table `dbhfapplication`
--

INSERT INTO `dbhfapplication` (`hfApplicationID`, `reasonToBecomeHF`, `whyIsNowRightTime`, `screenerName`, `screeningDate`, `approved`, `id`) VALUES
(1, '2', '2', 'name1', '0000-00-00', '0', 'vmsroot');
...
--
-- Dumping data for table `dbioovapplication`
--

INSERT INTO `dbioovapplication` (`ioovApplicationID`, `reasonToBecomeIOOV`, `whyIsNowRightTime`, `statusInRecoveryJourney`, `screenerName`, `screeningDate`, `approved`, `id`) VALUES
(1, '22', '22', '22', 'name1', '2222-02-22', '0', 'vmsroot');
...
(1, 'My reason', 'my time', 'Recovered', 'name1', '2020-02-22', 'vmsroot', 'TRUE');
...
--
ALTER TABLE `dbcsgapplication`
  MODIFY `csgApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `dbf2fapplication`
  MODIFY `f2fApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `dbfsgapplication`
  MODIFY `fsgApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dbhfapplication`
--
ALTER TABLE `dbhfapplication`
  MODIFY `hfApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dbioovapplication`
--
ALTER TABLE `dbioovapplication`
  MODIFY `ioovApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
